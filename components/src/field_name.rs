...
impl FormSchema for utils::types::Email {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(String::new())
    }
...
impl FormSchema for utils::types::Phone {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(String::new())
    }
...
impl FormSchema for utils::types::CardId {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(utils::types::CardId::default().to_string())
    }
}

impl FormSchema for utils::types::CollectionId {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(utils::types::CollectionId::default().to_string())
    }
}

impl FormSchema for utils::types::ScheduleId {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(utils::types::ScheduleId::default().to_string())
    }
}

impl FormSchema for utils::types::BookingTypeId {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(utils::types::BookingTypeId::default().to_string())
    }
}

impl FormSchema for utils::types::PersonId {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(utils::types::PersonId::default().to_string())
    }
}

impl FormSchema for utils::types::Code {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(String::new())
    }
...
impl FormSchema for utils::types::Password {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(String::new())
    }
...
impl FormSchema for utils::types::Username {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::Value::String(String::new())
    }
...
impl FormSchema for utils::types::Date {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::to_value(utils::types::Date::default())
            .unwrap_or(serde_json::Value::String(String::new()))
    }
}

impl FormSchema for utils::types::DateTime {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::to_value(utils::types::DateTime::default())
            .unwrap_or(serde_json::Value::String(String::new()))
    }
}

impl FormSchema for utils::types::Numeric {
    const FIELD_TYPE: FieldType = FieldType::Number;
    fn json_schema() -> serde_json::Value {
        serde_json::to_value(utils::types::Numeric::default()).unwrap_or(serde_json::json!(0))
    }
}

impl FormSchema for utils::types::Percentage {
    const FIELD_TYPE: FieldType = FieldType::Number;
    fn json_schema() -> serde_json::Value {
        serde_json::to_value(utils::types::Percentage::default()).unwrap_or(serde_json::json!(0))
    }
}

impl FormSchema for utils::ActivityKind {
    const FIELD_TYPE: FieldType = FieldType::String;
    fn json_schema() -> serde_json::Value {
        serde_json::to_value(utils::ActivityKind::default())
